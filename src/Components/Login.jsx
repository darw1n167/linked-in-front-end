...
const Login = () => {
  ...
  return (
    ...
    <div className="login-container">
      ...
      <button className="sign-in-app">
      <svg width='24' height='24' viewBox="0 0 170 170" fill="black">
    ...
    <div className="register">
            New to Linkedin?{' '}
            <span onClick={handleRegisterClick}>Join Now</span>
          </div>
    </div>}
        </>
      )}
